...
xpkg.build.provider-ctfd: do.build.images
...
# ====================================================================================
# End-to-end test (kind + CTFd + Crossplane + provider)

# test.e2e spins up a kind cluster, deploys CTFd, installs Crossplane and the
# provider, applies the example resources and asserts the result through the
# CTFd API. See test/e2e/run.sh for overridable variables (KEEP, CTFD_IMAGE...).
test.e2e:
	@./test/e2e/run.sh
