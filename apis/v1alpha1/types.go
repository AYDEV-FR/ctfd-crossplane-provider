...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,ctfd}
// A ProviderConfig configures a CTFd provider, i.e. a connection to a particular CTFd instance.
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,ctfd}
// A ClusterProviderConfig configures a CTFd provider.
